...
//Represents the number of rows and columns in the first matrix.
#define ROW_1 4
#define COL_1 4

//Represents the number of rows and columns in the second matrix.
